...
console.log(user, profileStorage)
  return (
    <>
             ...
             <NavBar></NavBar>
                ...
                { user ?(
                  <div className='dropdown signBtn'>
                    <button className='btn px-4 colorButton ms-2 dropdown-toggle' type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{profileStorage === null ? user.name : profileStorage}</button>
